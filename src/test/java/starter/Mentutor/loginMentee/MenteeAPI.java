...
public class MenteeAPI {
    ...
    public static final String BEARER_TOKEN_MENTEE = "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJJZENsYXNzIjoyNSwiYXV0aG9yaXplZCI6dHJ1ZSwiZXhwIjoxNjcwMjcyMzEzLCJyb2xlIjoibWVudGVlIiwidXNlcklkIjo2Mn0.F4H4YXsTExMWtI-2ZbFCwBrRzXhssMnITACKCYp00go";
    ...
    public void putUpdateProfile(){
        SerenityRest.given().multiPart("file", new File(ATTACHMENTS + "/bunga-lengkeng.jpg"))
                .multiPart("name","Rezki Update Sumatera")
    ...
    public void putUpdateProfileWhitoutAutorization(){
        SerenityRest.given().multiPart("file", new File(ATTACHMENTS + "/download.png"))
                .multiPart("name","Rezki Update Medan")
                .multiPart("email","rezkiadina02@gmail.com")
                .multiPart("password","Saya1234!@#$");
    }
}
